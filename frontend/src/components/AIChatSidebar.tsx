...
export const AIChatSidebar = ({ boardId, onRefreshBoard }: AIChatSidebarProps) => {
  const [isOpen, setIsOpen] = useState(false);
  const [messages, setMessages] = useState<Message[]>([
    { role: "assistant", content: "Hi! I am the PM AI. I can create, move, delete cards or rename/add columns. How can I help?" }
  ]);
